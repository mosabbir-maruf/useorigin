...
function GradientBackground({
  ...
  colors = [
    { color: "rgba(20,20,22,1)", stop: "10.5%" },
    { color: "rgba(45,25,15,1)", stop: "16%" },
    { color: "rgba(90,35,10,1)", stop: "17.5%" },
    { color: "rgba(120,40,10,1)", stop: "25%" },
    { color: "rgba(70,20,20,1)", stop: "40%" },
    { color: "rgba(30,15,30,1)", stop: "65%" },
  ...
  const generateGradient = () => {
    ...
    const getGradientPosition = (origin: GradientOrigin) => {
      const positions = {
